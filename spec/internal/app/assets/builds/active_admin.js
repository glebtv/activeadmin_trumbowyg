...
// ../../app/assets/javascripts/activeadmin_trumbowyg.js
init_inject_jquery();
(function() {
  "use strict";
  const THEME_KEY2 = "theme";
  function isDarkMode() {
  ...
  function updateEditorsTheme() {
    ...
    $3(".trumbowyg-box").each(function() {
      if (isDark) {
        $3(this).addClass("trumbowyg-dark");
      } else {
        $3(this).removeClass("trumbowyg-dark");
      }
    });
    $3(".trumbowyg-wrapper").each(function() {
      if (isDark) {
        $3(this).addClass("trumbowyg-dark");
      } else {
        $3(this).removeClass("trumbowyg-dark");
  ...
  function initTrumbowygEditors() {
    ...
    $3("[data-aa-trumbowyg], .trumbowyg-input").each(function() {
      if (!$3(this).hasClass("trumbowyg-textarea--active")) {
        let options = {
        ...
        const dataOptions = $3(this).data("options");
        if (dataOptions) {
          options = $3.extend({}, options, dataOptions);
        }
        if (!$3(this).parent().hasClass("trumbowyg-wrapper")) {
          const $wrapper = $3('<div class="trumbowyg-wrapper"></div>');
          if (isDarkMode()) {
            $wrapper.addClass("trumbowyg-dark");
          }
          $3(this).wrap($wrapper);
        }
        $3(this).trumbowyg(options);
        $3(this).addClass("trumbowyg-textarea--active");
        if (isDarkMode()) {
          $3(this).closest(".trumbowyg-wrapper").find(".trumbowyg-box").addClass("trumbowyg-dark");
        }
      }
    });
  }
  function setupEventListeners() {
    ...
    const darkModeMedia2 = window.matchMedia("(prefers-color-scheme: dark)");
    ...
    $3(document).on("click", ".has-many-add", function(event) {
      setTimeout(function() {
    ...
    $3(document).on("has_many_add:after", ".has_many_container", function() {
      console.log("ActiveAdmin Trumbowyg: Initializing for has_many fields (legacy event)");
      initTrumbowygEditors();
      updateEditorsTheme();
    });
    $3(document).on("turbo:load turbolinks:load", function() {
      initTrumbowygEditors();
      updateEditorsTheme();
    });
    $3(document).on("turbo:before-cache", function() {
      $3(".trumbowyg-textarea--active, .trumbowyg-input").each(function() {
        const $this = $3(this);
  ...
  if (typeof import_jquery2.default !== "undefined") {
    (0, import_jquery2.default)(setupEventListeners);
  } else if (typeof import_jquery.default !== "undefined") {
    (0, import_jquery.default)(setupEventListeners);
  } else {
